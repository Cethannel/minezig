...
const vs_source_wgsl = [650]u8 {
    ...
    0x28,0x78,0x5f,0x31,0x39,0x2e,0x6d,0x76,0x70,0x20,0x2a,0x20,0x70,0x6f,0x73,0x29,
...
const fs_source_wgsl = [418]u8 {
    ...
    0x0a,0x20,0x20,0x69,0x66,0x20,0x28,0x28,0x75,0x76,0x2e,0x78,0x20,0x3d,0x3d,0x20,
    ...
    0x31,0x2e,0x30,0x66,0x29,0x3b,0x0a,0x20,0x20,0x7d,0x0a,0x20,0x20,0x72,0x65,0x74,
...
pub fn selectorTextureSlot(tex_name: []const u8) ?usize {
    _ = tex_name;
    return null;
}
...
pub fn selectorStorageImageSlot(simg_name: []const u8) ?usize {
    _ = simg_name;
    return null;
}
