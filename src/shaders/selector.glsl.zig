...
//
//    Cmdline:
//        sokol-shdc -i src/shaders/selector.glsl -o src/shaders/selector.glsl.zig -l glsl430:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
//    Shader program: 'selector':
//        Get shader desc: shd.selectorShaderDesc(sg.queryBackend());
//        Vertex Shader: vs
//        Fragment Shader: fs
//        Attributes:
//            ATTR_selector_pos => 0
//            ATTR_selector_texcoord0 => 1
//    Bindings:
//        Uniform block 'vs_params':
//            Zig struct: VsParams
//            Bind slot: UB_vs_params => 0
//
pub const ATTR_selector_pos = 0;
pub const ATTR_selector_texcoord0 = 1;
...
//
//
const vs_source_glsl430 = [274]u8 {
...
//
//
const fs_source_glsl430 = [216]u8 {
...
//
//
const vs_source_glsl300es = [256]u8 {
...
//
//
const fs_source_glsl300es = [256]u8 {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
    ...
    0x66,0x20,0x28,0x75,0x76,0x2e,0x78,0x20,0x3d,0x3d,0x20,0x30,0x2e,0x30,0x29,0x0a,
...
const fs_source_hlsl5 = [514]u8 {
    ...
    0x20,0x20,0x20,0x69,0x66,0x20,0x28,0x75,0x76,0x2e,0x78,0x20,0x3d,0x3d,0x20,0x30,
...
//
//
const vs_source_metal_macos = [499]u8 {
...
//
//
const fs_source_metal_macos = [404]u8 {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
    ...
    0x31,0x2e,0x30,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x69,0x66,0x20,0x28,0x69,0x6e,
    0x2e,0x75,0x76,0x2e,0x78,0x20,0x3d,0x3d,0x20,0x30,0x2e,0x30,0x29,0x0a,0x20,0x20,
...
const vs_source_wgsl = [734]u8 {
    ...
    0x20,0x2a,0x20,0x78,0x5f,0x32,0x35,0x29,0x3b,0x0a,0x20,0x20,0x6c,0x65,0x74,0x20,
    0x78,0x5f,0x33,0x34,0x20,0x3a,0x20,0x76,0x65,0x63,0x32,0x66,0x20,0x3d,0x20,0x74,
    0x65,0x78,0x63,0x6f,0x6f,0x72,0x64,0x30,0x3b,0x0a,0x20,0x20,0x75,0x76,0x20,0x3d,
    0x20,0x78,0x5f,0x33,0x34,0x3b,0x0a,0x20,0x20,0x72,0x65,0x74,0x75,0x72,0x6e,0x3b,
    ...
    0x69,0x6f,0x6e,0x2c,0x20,0x75,0x76,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
//
//    diagnostic(off, derivative_uniformity);
//
...
const fs_source_wgsl = [462]u8 {
    ...
    0x32,0x20,0x3d,0x20,0x75,0x76,0x2e,0x78,0x3b,0x0a,0x20,0x20,0x69,0x66,0x20,0x28,
    0x28,0x78,0x5f,0x32,0x30,0x20,0x3d,0x3d,0x20,0x30,0x2e,0x30,0x66,0x29,0x29,0x20,
...
pub fn selectorShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    var desc: sg.ShaderDesc = .{};
    desc.label = "selector_shader";
    switch (backend) {
        .GLCORE => {
...
pub fn selectorAttrSlot(attr_name: []const u8) ?usize {
...
pub fn selectorImageSlot(img_name: []const u8) ?usize {
    _ = img_name;
    return null;
}
pub fn selectorSamplerSlot(smp_name: []const u8) ?usize {
    _ = smp_name;
    return null;
}
pub fn selectorUniformblockSlot(ub_name: []const u8) ?usize {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        return 0;
    }
    return null;
}
pub fn selectorUniformblockSize(ub_name: []const u8) ?usize {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        return @sizeOf(VsParams);
    }
    return null;
}
pub fn selectorUniformOffset(ub_name: []const u8, u_name: []const u8) ?usize {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
...
pub fn selectorUniformDesc(ub_name: []const u8, u_name: []const u8) ?sg.GlslShaderUniform {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        if (std.mem.eql(u8, u_name, "mvp")) {
...
pub fn selectorStoragebufferSlot(sbuf_name: []const u8) ?usize {
    _ = sbuf_name;
    return null;
}
